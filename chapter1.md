...
test_function("plot", index=3,  args=c("main", "col"), incorrect_msg = c("Kas kasutasid argumendi `main`, et väljastada graafikule pealkiri?", "Kas kasutasid sinist värvi tulpadele? (ingl. blue)"))
